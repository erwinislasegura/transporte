<div class="auth-heading">
    ...
    <p>Crea la empresa y el usuario Maestro. Podrás administrar los demás accesos desde el sistema.</p>
</div>
<form method="post" action="<?= e(url('/setup')) ?>" class="auth-form">
    ...
    <div class="row g-3">
        ...
        <div class="col-md-6"><label class="form-label" for="full_name">Nombre del Maestro</label><input class="form-control form-control-lg" id="full_name" name="full_name" value="<?= e(old('full_name')) ?>" required></div>
